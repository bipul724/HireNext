...
import { User, Settings as SettingsIcon, Bell, Shield, Save, Key, Trash2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-12">
      <div className="max-w-4xl mx-auto space-y-8 pb-20">
        ...
        <header>
          ...
          <p className="text-gray-500 mt-2 text-lg">Configure your AIcruiter account and interview engine.</p>
        </header>
